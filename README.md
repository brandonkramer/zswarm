...
| `doctor` | Inspect-only route/SSH/serve/Zellij/bus diagnosis | `session`, `timeout-ms` |
...
For inspect-only local/SSH/serve diagnosis, see [doctor](docs/doctor.md).
